...
flour = Ingredient.create({quantity: 1, name: "flour", unit: "cup", recipe_id: 1})
carrot = Ingredient.create({quantity: 2, name: "carrots", unit: "cup", recipe_id: 1})
chips = Ingredient.create({quantity: 1, name: "tortilla chips", unit: "bag", recipe_id: 2})
gb = Ingredient.create({quantity: 1, name: "ground beef", unit: "pound", recipe_id: 2})
